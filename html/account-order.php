...
<!-- Mirrored from MagMag-electronics16.netlify.com/html/account-order.php by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 02 May 2019 21:57:59 GMT -->
        ...
        <div class="col" id="main-sidebar">
          <div class="list-group list-group-flush">
            ...
            <a href="login.php" class="list-group-item list-group-item-action sub">Login / Register</a>
              ...
              <a href="account-order.php" class="list-group-item list-group-item-action sub active">My Orders</a>
            ...
            <div class="card-body">
              ...
              <div class="table-responsive">
                <table class="table table-hover">
                  ...
                  <tbody>
                    <tr>
                      <th scope="row"><a href="account-order-detail.php" class="text-info">1712697HPKINV</a></th>
                      <td>Dec 19, 2017</td>
                      <td>$74.00</td>
                      <td><span class="badge badge-warning">In Progress</span></td>
                    </tr>
                    <tr>
                      <th scope="row"><a href="account-order-detail.php" class="text-info">171264CK6FINV</a></th>
                      <td>Dec 10, 2017</td>
                      <td>$100.00</td>
                      <td><span class="badge badge-danger">Canceled</span></td>
                    </tr>
                    <tr>
                      <th scope="row"><a href="account-order-detail.php" class="text-info">171266PC4AINV</a></th>
                      <td>Dec 01, 2017</td>
                      <td>$20.00</td>
                      <td><span class="badge badge-success">Finished</span></td>
                    </tr>
                    <tr>
                      <th scope="row"><a href="account-order-detail.php" class="text-info">1711697HPKINV</a></th>
                      <td>Nov 19, 2017</td>
                      <td>$74.00</td>
                      <td><span class="badge badge-success">Finished</span></td>
                    </tr>
                    <tr>
                      <th scope="row"><a href="account-order-detail.php" class="text-info">171164CK6FINV</a></th>
                      <td>Nov 10, 2017</td>
                      <td>$100.00</td>
                      <td><span class="badge badge-success">Finished</span></td>
                    </tr>
