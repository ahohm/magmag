...
<!-- Mirrored from MagMag-electronics16.netlify.com/html/checkout-complete.php by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 02 May 2019 22:00:41 GMT -->
        ...
        <div class="col" id="main-content">
          ...
          <div class="text-center py-5 my-5">
            ...
            <p class="mb-0">
              ...
              <span class="text-pink">#ORD456789</span>
            </p>
            <p>
              <span class="text-muted">Amount: </span>
              <span class="text-pink">$1,297.48</span>
            </p>
            <p>A confirmation email has been sent to <u>user@example.com</u></p>
            <a href="grid.php" class="btn btn-secondary mb-5">CONTINUE SHOPPING</a>
            <a href="account-order.php" class="btn btn-success mb-5">VIEW ORDER</a>
          </div>
