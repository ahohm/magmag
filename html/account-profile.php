...
<!-- Mirrored from MagMag-electronics16.netlify.com/html/account-profile.php by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 02 May 2019 21:57:59 GMT -->
          ...
          <div class="list-group list-group-flush">
            ...
            <a href="login.php" class="list-group-item list-group-item-action sub">Login / Register</a>
                        <div class="collapse show" id="pages">
                          <a href="account-profile.php" class="list-group-item list-group-item-action sub active">My Profile</a>
          ...
          <div class="card user-card">
            <div class="card-body">
              ...
              <ul class="nav nav-pills">
                <li class="nav-item">
                  <a class="nav-link active" href="account-profile.php">Profile</a>
                </li>
                <li class="nav-item">
